...
void CLeakpressDlg::LoadConfig()
{
	...
	for (int k = 0; k < childs.size() && k < PLCADDSIZE; k++) {
		...
		else if (strstr(mkeyStr, "FILE"))
		{
			int id = (atoi)(mkeyStr.Right(1)) - 1;
			memcpy(para.files, mValueStr.GetBuffer(0), 6);
		}
	}
}
...
//	//	// 1.查询 PLC 复位信号
//	//	if (!bstart) {
//	//		bstart = pMain->IsStartState(id);
//	//		Sleep(500);
//	//		continue;
//	//	}
//
//	//	puts("====start====");
//	//	pMain->ResetAteqState(id);
//
//	//	// 2.等待 2 段稳压
//	//	do {
//	//		pMain->QueryAteqTest(id);
//	//		Sleep(100);
//	//	} while (pMain->IsAteqStateMatch(id, ATEQ_REST));
//
//
//	//	
//	//	// 3.等待 2 段稳压结束
//	//	bool error = true;
//	//	while (pMain->IsAteqStateMatch(id, ATEQ_STABLE_1)) {
//	//		pMain->QueryAteqTest(id);
//	//		error = false;
//	//		Sleep(100);
//	//	}
...
//	//	}
//
//	//	while (!pMain->IsAteqStateMatch(id, ATEQ_TEST_1, false)) {
//	//		pMain->QueryAteqTest(id);
//	//		Sleep(100);
//	//	}
//
...
//	//	// 4.查询 2 段结果
//	//	do {
//	//		pMain->QueryAteqResult(id);
//	//		Sleep(100);
//	//	} while (!pMain->IsAteqStateMatch(id, ATEQ_RESULT_1, false));
//	//	
//	//	puts("等待 3 段稳压");
//
//	//	// 5. 等待 3 段稳压
...
//	//		pMain->QueryAteqTest(id);
//	//		Sleep(100);
//	//	} while (!pMain->IsAteqStateMatch(id, ATEQ_STABLE_2, false));
//
//	//	if (pMain->QueryAteqState(id) == ATEQ_STABLE_2) {
//	//		puts("sending test press");
//	//	}
//
//	//	// 6. 3 段稳压，一直发送结果
...
//	//	// 7.等待 PLC 获取结果
//	//	puts("wait plc get result");
//	//	while (!pMain->IsGetResult(id)) {
//	//		Sleep(200);
//	//	}
//
//	//	puts("send result");
//	//	pMain->SendResult(id); // 给 PLC 发送结果
//
//	//	puts("waiting end");
//
//	//	// 8.等待 PLC 结束
//	//	while (!pMain->IsEndState(id)) {
//	//		Sleep(100);
//	//	}
//
//	//	bstart = false;
